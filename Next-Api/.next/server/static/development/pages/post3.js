...
const Post3 = props => __jsx(_components_Layout_js__WEBPACK_IMPORTED_MODULE_1__["default"], null, __jsx("div", {
  style: {
    alignContent: "center",
  ...
  class: "list-group-item list-group-item-action"
}, "LANGUAGE: ", props.title.language)))); //Get forwarded data by id
...
Post3.getInitialProps = async function (context) {
  ...
  const res = await isomorphic_unfetch__WEBPACK_IMPORTED_MODULE_2___default()(`https://swapi.co/api/species/${id}`);
...
/***/ 6:
/*!******************************!*\
  !*** multi ./pages/post3.js ***!
  \******************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

module.exports = __webpack_require__(/*! C:\Users\MACHIMANA-VICTOR\Documents\Hyperion Dev Tasks\Level 3\Task 9\Next-Api\pages\post3.js */"./pages/post3.js");
